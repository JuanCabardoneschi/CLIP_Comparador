...
CLIP_CATEGORIES = [
    ...
    "casaca de chef profesional, chaqueta de cocina, chef jacket with buttons",
    "zueco profesional de trabajo, calzado antideslizante, work clogs shoes",
    "gorro profesional, gorra de trabajo con visera, boina calada, cap hat work headwear",
