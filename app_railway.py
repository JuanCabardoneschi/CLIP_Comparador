#!/usr/bin/env python3
"""
CLIP Comparador - Aplicación principal para Railway
Sistema de búsqueda visual con modelo CLIP optimizado para producción
"""
...
if __name__ == '__main__':
    # Inicializar el sistema (modelo CLIP y embeddings)
    ...
    try:
        # Usar waitress para servidor de producción sin warnings
